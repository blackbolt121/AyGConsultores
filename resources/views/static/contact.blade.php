                    ...
                    <div class="space-y-8 relative z-10">
                        <div class="flex items-start gap-4 group">
                            ...
                            <div>
                                ...
                                <a href="mailto:contacto@aygconsultores.com.mx" class="text-white font-medium hover:text-white/80 transition-colors break-all">contacto@aygconsultores.com.mx</a>
                            </div>
                        </div>
                    </div>
                </div>
