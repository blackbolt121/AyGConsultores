                ...
                <table class="w-full text-sm text-left">
                     <thead class="text-xs text-gray-500 bg-gray-50/50 border-b border-gray-200">
                         <tr>
                             ...
                             <th class="px-6 py-3 font-medium">Progreso</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                         @foreach($enrollments as $enrollment)
                             <tr class="hover:bg-gray-50/50 transition-colors">
                                 ...
                                 <td class="px-6 py-4">
                                     @php
                                       $p = ($progressByUser[$enrollment->user_id] ?? ['percent' => 0, 'completed' => 0, 'total' => 0]);
                                     @endphp
                                     <div class="min-w-[180px]">
                                       ...
                                       <div class="mt-2 h-2 w-full rounded-full bg-slate-100 overflow-hidden">
                                         <div class="h-full rounded-full bg-gradient-to-r from-primary to-secondary" style="width: {{ $p['percent'] }}%"></div>
                                       </div>
                                     </div>
                                 </td>
